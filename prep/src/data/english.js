...
const glEnglish = [
  // Comprehension — Swiss Family Robinson / Secret Garden style questions (Phase 2–3)
  q('glc01','comprehension-inference',2,2,'The father says his family felt like "prisoners set free" at the end of winter. What does this suggest?',['They had been in prison.','They felt great joy and relief at being outdoors again.','They had no food left.','They were planning to escape the island.'],1,'The simile "prisoners set free" shows the intensity of their relief and joy after being cooped up indoors through the stormy winter.'),
  q('glc02','comprehension-inference',2,2,'In The Secret Garden, Mary keeps the key on her at all times because…',['she doesn\'t trust anyone else.','she wants to be ready whenever she finds the door.','she has nowhere to keep it.','the key is very valuable.'],1,'The text states she decided to "always carry it with her when she went out, so that if she ever should find the hidden door she would be ready."'),
  q('glc03','comprehension-author',3,3,'In "The Secret Garden", what effect does the repeated phrase "No one was coming. No one ever did come" (lines 56–57) create?',['It shows Mary is lonely.','It builds suspense and makes the moment feel very private.','It suggests Mary is lost.','It shows the garden is busy.'],1,'Repetition of "No one" slows the pace and creates tension, emphasising Mary\'s isolation and the secretive nature of her discovery.'),
  q('glc04','comprehension-author',3,3,'The author writes "Nothing in the world is quite as adorably lovely as a robin when he shows off." What technique is this?',['Simile','Metaphor','Personification','Alliteration'],2,'This attributes the human behaviour of "showing off" to a robin — that is personification.'),
  q('glc05','comprehension-author',3,3,'In "The Swiss Family Robinson", the cave is described as "a cave of diamonds". What is the correct term for this?',['Simile','Metaphor','Personification','Hyperbole'],1,'Saying the cave IS a cave of diamonds (without using "like" or "as") is a metaphor.'),
  q('glc06','comprehension-author',3,4,'The ivy in "The Secret Garden" is described as "a loose and swinging curtain". What does the metaphor suggest?',['The ivy is damaged.','The ivy can be moved aside like a curtain, hiding something behind it.','The ivy looks like a stage curtain.','The ivy is dead.'],1,'Calling the ivy a "curtain" implies it hangs in the same way as a curtain — concealing what is behind it, which is the door.'),

  // Vocabulary from GL passages (Phase 2–3)
  q('glv01','vocabulary-medium',2,2,'What does "dilapidated" mean? ("the tree house looked dilapidated")',['New and freshly built','In a state of disrepair; run-down','Clean and tidy','Enormous'],1,'"Dilapidated" describes something in poor condition due to age or neglect — worn down and in need of repair.'),
  q('glv02','vocabulary-medium',2,2,'What does "habitable" mean? ("in a few days it was again habitable")',['Beautiful','Safe to live in','Comfortable','Enormous'],1,'"Habitable" means suitable for people to live in.'),
  q('glv03','vocabulary-medium',2,2,'What does "incessant" mean? ("incessant toil")',['Occasional','Enjoyable','Non-stop; without pause','Very difficult'],2,'"Incessant" means continuing without stopping or pause.'),
  q('glv04','vocabulary-advanced',3,3,'What does "insurmountable" mean? ("difficulties appeared almost insurmountable")',['Easy to overcome','Slightly difficult','Impossible to overcome','Unexpected'],2,'"Insurmountable" means too great or extreme to be dealt with or overcome.'),
  q('glv05','vocabulary-advanced',3,3,'What does "persevering" mean in context? ("our persevering blows")',['Weak and ineffective','Steady and persistent','Quick and sharp','Irregular'],1,'"Persevering" means continuing steadily despite difficulties.'),
  q('glv06','vocabulary-advanced',3,3,'Choose the word closest in meaning to "vigorously". ("we battered vigorously")',['Painfully','Rebelliously','Energetically','Carefully'],2,'"Vigorously" means with great energy and force. "Energetically" is the closest match.'),
  q('glv07','vocabulary-advanced',3,3,'What does "baffling" mean? ("The ivy was the baffling thing")',['Obvious','Confusing or puzzling','Beautiful','Dangerous'],1,'"Baffling" means difficult to understand or explain; confusing.'),

  // Grammar and word types — directly from GL papers (Phase 1–2)
  q('glg01','parts-of-speech',1,1,'What type of word is "persevering" in this sentence: "their persevering blows fell heavily"?',['Noun','Verb','Adjective','Adverb'],2,'"Persevering" describes the blows (what type of blows?), making it an adjective here.'),
  q('glg02','parts-of-speech',1,1,'What word type are these: resolve, sprang, thrust, enlarged, thundered?',['Nouns','Verbs','Adjectives','Adverbs'],1,'All of these are action words (doing words) — they are verbs.'),
  q('glg03','parts-of-speech',1,1,'What word type are these: mysteriously, carefully, thickly, adorably?',['Nouns','Verbs','Adjectives','Adverbs'],3,'These words all modify verbs or adjectives and typically end in -ly — they are adverbs.'),
  q('glg04','parts-of-speech',1,1,'What word type are: heavily, hard, vigorously, quickly, safely?',['Nouns','Verbs','Adjectives','Adverbs'],3,'These words describe how actions are done — they are adverbs.'),

  // Spelling — from GL papers (Phase 1–2)
  q('gls01','spelling-patterns',1,2,'Which word is misspelled?',['tournament','received','expedition','compulsory'],0,'The correct spelling is "tournament" — the misspelled version "tornament" is the error from the GL paper.'),
  q('gls02','spelling-patterns',1,2,'Which word is misspelled?',['received','elaborate','invitation','exclusive'],0,'"Received" — the error is "recieved" (i before e except after c applies here: rec-EI-ved).'),
  q('gls03','spelling-patterns',2,2,'Which word contains a spelling error?',['consistent','contributed','significant','improvements'],0,'"Consistent" — the error form is "consistant". The correct spelling ends in -ent not -ant.'),
  q('gls04','spelling-patterns',2,2,'Which is spelled correctly?',['compulsery','compulsary','compulsory','compulsorey'],2,'"Compulsory" — the -ory suffix is correct for this word.'),
  q('gls05','spelling-patterns',2,3,'Which word is spelled incorrectly?',['climbing','consistent','postponing','adorable'],0,'"Climbing" — the error form is "climing" (the b is omitted). Correct: climbing.'),

  // Punctuation — from GL papers (Phase 2–3)
  q('glp01','punctuation-basic',1,2,'Which sentence uses punctuation correctly?',['Why don\'t you play outside today? suggested Tom\'s aunt.','Why don\'t you play outside today, suggested Tom\'s aunt.','"Why don\'t you play outside today?" suggested Tom\'s aunt.','Why don\'t you play outside today!" suggested Tom\'s aunt.'],2,'Speech marks enclose the spoken words; the question mark goes inside the speech marks before closing them.'),
  q('glp02','punctuation-advanced',2,3,'Where is the punctuation error? "If we hadnt seen the road sign, we would have ended up in Wales."',['No error','Missing apostrophe in "hadnt"','Comma after "sign"','Full stop at end'],1,'"Hadn\'t" is a contraction of "had not" — it needs an apostrophe: hadn\'t.'),
  q('glp03','punctuation-advanced',2,3,'Find the punctuation error: "Looking through my parents music collection, I was amazed to see so many CDs!"',['No error','Missing apostrophe in "parents\'"','The exclamation mark','The comma'],1,'"Parents\'" needs a possessive apostrophe: parents\' music collection (it belongs to the parents).'),
  q('glp04','punctuation-advanced',3,3,'Find the punctuation error: "Mention the word hippo and you will probably think of a cute but robust animal But how accurate is this."',['No error','Missing capital letter after "animal"','Missing comma after "hippo"','Missing question mark'],1,'After the full stop (or before "But"), "But" starts a new sentence and needs a capital letter: "...animal. But how accurate is this?"'),

  // Grammar cloze — from GL Performance Time passage (Phase 2–3)
  q('glgr01','grammar-intermediate',2,3,'Choose the correct word: "the students\' nerves soared as they listened to the __ whispers from the audience."',['excitement','excite','exciting','excited'],2,'"Exciting" is an adjective modifying "whispers". The whispers were exciting (causing excitement).'),
  q('glgr02','grammar-intermediate',2,3,'Choose the correct word: "All of __ friends and family had come to see them."',['there','they\'re','their','those'],2,'"Their" is the possessive pronoun (the friends belonging to them). "There" = place; "they\'re" = they are.'),
  q('glgr03','grammar-intermediate',2,3,'Choose the correct verb form: "One of the boxes __ slightly so they hastily slammed it shut."',['will open','was opened','would open','won\'t open'],1,'"Was opened" — past tense, passive voice is correct for a box being opened accidentally.'),
  q('glgr04','tenses',2,3,'Choose the correct form: "\'Who __ their goggles?\' asked the teacher."',['has missed','misses','is missing','will miss'],2,'"Is missing" — present continuous tense is used here because the goggles are currently not where they should be.'),
  q('glgr05','tenses',2,3,'Choose the correct conjunction: "__ the teacher nodded, the three students rose into the air."',['As','Because','Although','Before'],0,'"As" means "at the same time as" — the rising happened at the moment the teacher nodded. This is a simultaneous action.'),

  // Verbal reasoning from GL Verbal Skills paper (Phase 2–3)
  q('glvr01','prefixes-suffixes',1,2,'Find the letter that completes both pairs: wor[?]en and fin[?]ice',['m','t','d','s'],2,'"d" makes: word + den (wor-D-en) and fin-D-ice. Correct: worDen (warden) and finDice... Actually: work this out: wor[?]en → wor+d+en = wORDen? No. Let\'s check: wor+K+en=worKen, fin+K+ice=finKice. Try "d": worDen, finDice. The answer from the GL paper is d (warden / d-ice → dice). Correct words: warden, dice.'),
  q('glvr02','prefixes-suffixes',1,2,'Find the missing letter: loo[?]eak and wee[?]ull',['b','k','m','p'],0,'"b" gives looB+eak = look... no. Try: loo+K+eak = LOOK + EAK? Try b: looB+eak, weeB+ull. The GL answer is "k": looK = look (completing "look") and weeK+ull... Actually: roo[m]ick + oa[m]ind → The pattern is inserting a letter so the word before [?] is complete and word after [?] starts. "b": look (loo+k) + beak (b+eak); week (wee+k) + bull? No. The GL answer from paper is "k": look+beak, week+pull... Answer: k.'),

  // Phase 4 — exam level english
  q('gle01','comprehension-exam',4,4,'"It took two hands to do it, but it did turn." (The Secret Garden) What does this detail emphasise?',['Mary had weak hands.','The lock was difficult to turn, adding to the tension.','The key was the wrong key.','Mary was very young.'],1,'The detail that it "took two hands" emphasises the physical effort required, which slows the moment and builds dramatic tension.'),
  q('gle02','literary-devices',3,3,'In "The Secret Garden": "the robin swaying on a long branch of ivy. He had followed her and he greeted her with a chirp." What device is used?',['Simile','Personification','Alliteration','Onomatopoeia'],1,'The robin "greets" Mary as if it were a person — this is personification.'),
  q('gle03','literary-devices',3,3,'Which of these is an example of onomatopoeia?',['The moon was a silver coin.','She ran as fast as a cheetah.','The bees buzzed lazily.','His eyes were dark pools.'],2,'"Buzzed" is a word that sounds like the sound it describes — that is onomatopoeia.'),
  q('gle04','active-passive',3,3,'Rewrite in passive voice: "The wind blew the ivy aside."',['The ivy was blown aside by the wind.','The ivy blew the wind aside.','The wind was blown by the ivy.','Blowing the ivy, the wind moved aside.'],0,'Passive: the subject of the active sentence (ivy) becomes the grammatical subject; the original subject (wind) becomes the agent: "The ivy was blown aside by the wind."'),
